...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Estimations.elf
...
MODELREF_LINK_RSPFILE_NAME = Estimations_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Estimations.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Estimations_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Estimations -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/Estimations_ert_rtw/Estimations.c $(START_DIR)/Estimations_ert_rtw/Estimations_data.c $(START_DIR)/Estimations_ert_rtw/ert_main.c
...
OBJS = Estimations.o Estimations_data.o
...
%.o : $(START_DIR)/Estimations_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Estimations_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Estimations_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Estimations_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Estimations_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
